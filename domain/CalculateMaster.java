...
@AllArgsConstructor
@Entity
@Table(name = "tb_calculate_master")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CalculateMaster extends AbstractAuditingEntity<String> implements Persistable<String> {
    ...
    @NotNull
    @Size(max = 36)
    @Column(name = "calculate_id", length = 36, nullable = false, unique = true)
...
//    private String saleUserId;
    ...
    private ContentsBuyMaster contentsBuyId;
    ...
    private ContentsBuyMaster saleUserId;

    @OneToMany(mappedBy = "calculateMaster")
    @Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
    ...
    public CalculateMaster calculateCharge(CalculateCharge calculateCharge) {
        this.setCalculateCharge(calculateCharge);
        return this;
    }

    public ContentsBuyMaster getContentsBuyId() {
        return this.contentsBuyId;
    }

    public void setContentsBuyId(ContentsBuyMaster contentsBuyMaster) {
        this.contentsBuyId = contentsBuyMaster;
    }

    public CalculateMaster contentsBuyId(ContentsBuyMaster contentsBuyMaster) {
        this.setContentsBuyId(contentsBuyMaster);
        return this;
    }

    public ContentsBuyMaster getSaleUserId() {
        return this.saleUserId;
    }

    public void setSaleUserId(ContentsBuyMaster contentsBuyMaster) {
        this.saleUserId = contentsBuyMaster;
    }

    public CalculateMaster saleUserId(ContentsBuyMaster contentsBuyMaster) {
        this.setSaleUserId(contentsBuyMaster);
        return this;
    }
    ...
    public void setCalculateHists(Set<CalculateHist> calculateHists) {
        if (this.calculateHists != null) {
            this.calculateHists.forEach(i -> i.setCalculateMaster(null));
        }
        if (calculateHists != null) {
            calculateHists.forEach(i -> i.setCalculateMaster(this));
        }
        this.calculateHists = calculateHists;
    }

    public CalculateMaster calculateHists(Set<CalculateHist> calculateHists) {
        this.setCalculateHists(calculateHists);
        return this;
    }

    public CalculateMaster addCalculateHist(CalculateHist calculateHist) {
        this.calculateHists.add(calculateHist);
        calculateHist.setCalculateMaster(this);
        return this;
    }

    public CalculateMaster removeCalculateHist(CalculateHist calculateHist) {
        this.calculateHists.remove(calculateHist);
        calculateHist.setCalculateMaster(null);
        return this;
    }
