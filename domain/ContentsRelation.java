...
@AllArgsConstructor
@Entity
@Table(name = "tb_contents_relation")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
@SuppressWarnings("common-java:DuplicatedBlocks")
public class ContentsRelation extends AbstractAuditingEntity<String> implements Persistable<String> {
    ...
    public ContentsRelation setIsPersisted() {
    ...
    public ContentsRelation contentsCatalogMaster(ContentsCatalogMaster contentsCatalogMaster) {
